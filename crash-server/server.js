...
import fs from 'fs';       // 🚨 NEW: to read the certificate files
import path from 'path';   // 🚨 NEW: to resolve the path
import { Server } from 'socket.io';
import { createClient } from '@supabase/supabase-js';
import dotenv from 'dotenv';
import cors from 'cors';
import crypto from 'crypto';
import { fetchDailySeed } from './daily-vrf-seed.ts'; // 🚨 NEW: Import the daily VRF seed fetcher
...
// 🚨 NEW: Load the SSL certificates generated by Next.js
// Adjust this path if your crash-server folder is located elsewhere!
const options = {
  key: fs.readFileSync(path.join(__dirname, '../certificates/localhost-key.pem')),
  cert: fs.readFileSync(path.join(__dirname, '../certificates/localhost.pem'))
};

// 🚨 CHANGED: Create an HTTPS server instead of HTTP
